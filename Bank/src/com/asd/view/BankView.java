...
public class BankView implements AccountView {
	...
	@Override
	public void createAccount(Customer custoemr, String accountType, String accountNumber, double balance) {
		accountService.createAccount(custoemr, accountType, accountNumber, balance);
	}
